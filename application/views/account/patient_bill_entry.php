	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			<form action="#" id="form_sample_1" class="form-horizontal">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group row">
									<label class="control-label col-md-4">Bill Id<span class="required"> * </span> </label>
									<div class="col-md-8">
				...
				<div class="card card-topline-red">
					<div class="card-head">
						<header>Patient Bill Entry</header>
					</div>
					<div class="card-body ">
						<div class="row">
							...
							<div class="col-md-5">
								...
								<div class="form-group row">
									<label class="control-label col-md-4" style="padding-right: 5px;">Bill Head
										<span class="required"> * </span>
									</label>
									<div class="col-md-8">
										<select class="form-control input-height" name="department">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card card-topline-aqua">
				<div class="card-head">
					<header>Patient Bill List</header>
				</div>
				<div class="card-body ">
