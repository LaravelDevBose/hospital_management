	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			<div class="card card-topline-aqua">
				<div class="card-body ">
					<form action="#" id="purchase_return_search" class="form-horizontal">
						<div class="row">
								...
								<div class="form-group row">
									...
									<div class="col-md-8">
										<select class="form-control  select2" id="invoice_id" data-placeholder="Select a Invoice" onchange="search_type_toggle($(this).val());">
											...
											<option value="6">P00006</option>
											<option value="5">P00005</option>
											<option value="4">P00004</option>
											<option value="3">P00003</option>
											<option value="2">P00002</option>
											<option value="1">P00001</option>
										</select>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group row">
									<label class="control-label col-md-4">Purchase Date </label>
									<div class="col-md-8">
...
<script>
	$(document).ready(function (){
		$('#purchase_return_search').submit(function(){
